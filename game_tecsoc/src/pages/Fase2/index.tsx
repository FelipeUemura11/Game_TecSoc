  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 left-50" style={{ zIndex: 10 }}>
        <h2 className="text-white text-4xl font-jersey"> FASE 2</h2>
      </div>

      <img 
        src={Pedro} 
        alt="Pedro" 
        className="absolute bottom-0 right-0 w-auto h-170 character-appear" 
        style={{ zIndex: 10 }} 
      />
      <div className="absolute bottom-10 left-25 bg-black/70 w-350 h-auto border-2 border-black/85" style={{ zIndex: 10 }}>
        <h2 className="text-white text-xl font-bold"> PEDRO </h2>
